...
const Header = () => {
  ...
  return (
    <nav className="py-[15px] px-[16px]">
      <div className=" items-center space-x-6 flex justify-between">
        <div className=" items-center space-x-3 flex ">
          ...
          <div className=" hidden xl:flex">
            {headerLinks.map((link, index) => (
              <div
                key={index}
                className="flex items-center rounded-md hover:bg-gray-100 p-2"
              >
                <Link
                  key={index}
                  href="#"
                  className="text-black  text-[15px] leading-[16px] font-medium"
                >
                  {link}
                </Link>
        ...
        <div className="xl:hidden">
          ...
          {!isMobileMenuOpen && (
            <div className="fixed inset-0 bg-white mt-[48px] xl:hidden">
